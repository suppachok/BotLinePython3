...
#==============================================================================#
                    ...
                    try:
                        ...
                        ret_ += "\n╠ ห้อง : {}".format(str(len(grouplist)))
                        ret_ += "\n╠ เพื่อน : {}".format(str(len(contactlist)))
                        ret_ += "\n╠ คนที่บล็อค : {}".format(str(len(blockedlist)))
                        ret_ += "\n╠══[ ข้อมูลเซลบอท ]"
                        ret_ += "\n╠ เวอร์ชั่น : Beta Test"
